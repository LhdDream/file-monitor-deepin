...
constexpr EpollEventType Readable() { return EpollEventType( EpollEventType::KReadble ); }

constexpr EpollEventType Writeable() { return EpollEventType(EpollEventType::KWriteable ); }
